...
function SignIn() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      // Перенаправляем на другую страницу после успешного входа
      navigate('/profile');
    } catch (error) {
      console.error('Ошибка при входе:', error.response?.data);
      alert('Ошибка при входе! Пожалуйста, проверьте ваши учетные данные и попробуйте снова.');
    }
  };
    ...
    <section className="m-8 flex gap-4">
      <div className="w-full lg:w-3/5 mt-24">
        <div className="text-center">
          ...
          <Typography variant="paragraph" color="blue-gray" className="text-lg font-normal">Введите ваш email и пароль для входа.</Typography>
        </div>
        <form className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2" onSubmit={handleSubmit}>
          ...
          <Typography variant="paragraph" className="text-center text-blue-gray-500 font-medium mt-4">
            Нет аккаунта?
            <Link to="/sign-up" className="text-gray-900 ml-1">Зарегистрироваться</Link>
          </Typography>
        </form>
      </div>
